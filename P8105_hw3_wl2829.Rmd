...
acce_df %>% 
  ...
  geom_point()
```
This plot shows that the fluctuation of each day's data in different weeks is very obvious. However, their changing trends are very different. At the same time, the data gap at different times within a week is also relatively large. The data in the figure does not show a very obvious trend or law.
